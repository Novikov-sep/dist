(() => {
    ...
    let paginations = document.querySelectorAll(".swiper-pagination-sec__item");
    let wrapPagination = document.querySelector(".swiper-pagination-sec");
        ...
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
            ...
            pagination: {
                ...
                renderBullet: function(index, className, text = [ "North Shore", "South Shore", "West Shore", "East Shore" ]) {
                    return `<div class="${className}">\n\t\t\t\t\t<div class="swiper-pagination__line"></div>\n\t\t\t\t\t<div class="swiper-pagination__body">\n\t\t\t\t\t\t<div class="swiper-pagination__number">${index + 1}</div>\n\t\t\t\t\t\t<div class="swiper-pagination__text">${text[index]}</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>`;
                }
            },
            breakpoints: {
                320: {
            ...
            on: {
                afterInit: function(swiper) {
                    paginations[swiper.activeIndex].classList.add("_active");
                    wrapPagination.addEventListener("click", (function(e) {
                        wrapPagination.querySelector("._active").classList.remove("_active");
                        swiper.slideTo(e.target.dataset.index);
                        paginations[swiper.activeIndex].classList.add("_active");
                    }));
                },
                slideChange: function(swiper) {
                    wrapPagination.querySelector("._active") ? wrapPagination.querySelector("._active").classList.remove("_active") : null;
                    paginations[swiper.activeIndex].classList.add("_active");
                }
            }
        });
    ...
    da.init();
    const dateNumber = document.querySelector(".date__number");
    const dateMonth = document.querySelector(".date__month");
    const dateYear = document.querySelector(".date__year");
    const geoLocation = document.querySelector(".header__location").querySelector("svg");
    let date = new Date;
    dateNumber.innerHTML = date.getDate();
    dateMonth.innerHTML = date.toLocaleString("default", {
        month: "2-digit"
    });
    ...
    geoLocation.insertAdjacentHTML("afterend", `${geo}`);
    ...
    searchButton.addEventListener("click", (e => {
        if (htmlItem.classList.contains("touch")) searchForm.classList.toggle("_active"); else searchInput.value = "";
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
